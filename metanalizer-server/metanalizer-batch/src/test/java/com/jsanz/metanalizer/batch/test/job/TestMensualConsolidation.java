...
import com.jsanz.metanalizer.batch.consolidacion.MensualConsolidacion;
import com.jsanz.metanalizer.batch.scraping.MtgGolfishJobPlan;
import com.jsanz.metanalizer.batch.test.config.TestMensualConsolidationConfig;
...
@ContextConfiguration(classes = {DatabaseConfig.class, MensualConsolidacion.class, TestMensualConsolidationConfig.class, BatchConfig.class})
public class TestMensualConsolidation {
	...
	public void stepScraping() {
		JobExecution jobExecution=jobLauncherTestUtils.launchStep("mensualConsolidationStep", defaultJobParameters());
